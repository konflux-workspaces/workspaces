...
func (r *MasterUserRecordReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Client.Get(ctx, req.NamespacedName, &m); err != nil {
		if kerrors.IsNotFound(err) {
			return ctrl.Result{}, r.ensureWorkspaceIsDeleted(ctx, req.NamespacedName)
		}
...
func (r *MasterUserRecordReconciler) ensureWorkspaceIsPresent(ctx context.Context, m toolchainv1alpha1.MasterUserRecord) error {
	w := &workspacesv1alpha1.Workspace{ObjectMeta: metav1.ObjectMeta{Name: m.Name, Namespace: m.Namespace}}
...
func (r *MasterUserRecordReconciler) ensureWorkspaceIsDeleted(ctx context.Context, nn types.NamespacedName) error {
